...
class DegreeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $degree->save();
        return redirect()->route('admin.degree.index')->with('message','degree Add Successfully');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $degree->save();
        return redirect()->route('admin.degree.index')->with('message','degree Update Successfully');
