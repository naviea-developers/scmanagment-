...
class ShelfController extends Controller
{
    public function index()
    {
        ...
        return view("Backend.library_management.shelf.index",$data);
    }
    ...
    public function store(Request $request)
    {
      // dd($request->all());
        ...
        try{
            ...
            DB::commit();
            return redirect()->route('admin.shelf.index')->with('message','Shelf Add Successfully');
        }catch(\Exception $e){
            DB::rollBack();
            dd($e);
    ...
    try{
        ...
        DB::commit();
        return redirect()->route('admin.shelf.index')->with('message','Shelf Update Successfully');
    }catch(\Exception $e){
        DB::rollBack();
       // dd($e);
        return back()->with ('error_message', $e->getMessage());
