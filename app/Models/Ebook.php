...
class Ebook extends Model
{
    ...
    public function getImageShowAttribute(){
        return $this->image != "" ? asset("public/upload/ebook/".$this->image) : asset("public/frontend/images/no-profile.jpg");
    }
    ...
    function getContentAudioShowAttribute(){
        return $this->content_audio == '' ? $this->no_image : asset("public/upload/ebook/".$this->content_audio);
    }
