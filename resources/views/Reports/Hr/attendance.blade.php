                ...
                <div class="row row-card-one">
                    <div class="col-sm-12 ">
                        <div class="row report-title">
                            <h4 class=""><b>Attendance Report</b></h4>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        ...
                        <div class="search-Section">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class=" form-control  fl_datepicker from_date" value="{{ $from_date }}" name="from_date" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
                                    <label for=""><b>To Date</b></label>
                                    <input type="text" class=" form-control  fl_datepicker to_date" value="{{ $to_date }}" name="to_date" autocomplete="off" required>
                                </div>
                                <div class="col-sm-3">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="d-flex">
                                ...
                                <form action="{{ route('report_attendance_pdf') }}" method="GET">
                                ...
                                <form action="{{ route('report_attendance_print') }}" method="GET">
                                    <input type="hidden" value="{{ $from_date }}" name="p_from_date" class="p_from_date">
                                    <input type="hidden" value="{{ $to_date }}" name="p_to_date" class="p_to_date">
                                    <input type="hidden" name="p_department" class="p_department">
                                    <input type="hidden" name="p_designation" class="p_designation">
                                ...
                                <form action="{{ route('report_attendance_excel') }}" method="GET">
                                    <input type="hidden" value="{{ $from_date }}" name="p_from_date" class="p_from_date">
                                    <input type="hidden" value="{{ $to_date }}" name="p_to_date" class="p_to_date">
                                   <input type="hidden" name="p_department" class="p_department">
                                    <input type="hidden" name="p_designation" class="p_designation">
