 ...
 <div class="br-header">
    ...
    <div class="br-header-right">
        ...
        <div class="dropdown">
          <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                @if (!empty(Session::get('userImg')))
                    <img src="{{ url('/backend/profile_picture') }}/{{ Session::get('userImg') }}" class="wd-80
                    rounded-circle" alt="" style="height: 25px;width: 25px;object-fit:cover;">
                        @else
                    <img src="{{ url('/backend/profile_picture') }}/dft/user.png" class="wd-80
                    rounded-circle" alt="" style="height: 25px;width: 25px;object-fit:cover;">
                @endif
          ...
          <div class="dropdown-menu dropdown-menu-header wd-250">
            <div class="tx-center">
              <a href="">
                @if (!empty(Session::get('userImg')))
                    <img src="{{ url('/backend/profile_picture') }}/{{ Session::get('userImg') }}" class="wd-80
                    rounded-circle" alt="" style="height: 100px;width:100px;object-fit:cover;">
                        @else
                    <img src="{{ url('/backend/profile_picture') }}/dft/user.png" class="wd-80
                    rounded-circle" alt="">
                @endif
            ...
            <ul class="list-unstyled user-profile-nav">
                <li>
                    <a href="editprofile/{{ Session::get('userId') }}">
      ...
      <div class="navicon-right">
        ...
        <a href="/teacherlogout" title="logout">
