                    ...
                    <div class="d-flex">
                        ...
                        @if (auth()->user()->type == 1)
                            <div style="margin-left: 10px">
                                <a href="{{ route('student.edit_profile', auth()->user()->id) }}" class="btn" style="background-color:var(--button2_color); color:var(--button2_text_color)">Student Edit Profile</a>
                            </div>
                        @else
                            <div style="margin-left: 10px">
                                <a href="{{ route('user.edit_profile', auth()->user()->id) }}" class="btn" style="background-color:var(--button2_color); color:var(--button2_text_color)">Edit Profile</a>
                            </div>
                        @endif
                    </div>
                ...
                <div class="row">
                    ...
                    @if (auth()->user()->type == 1)
                        <div class="col-md-4 mt-3">
                            ...
                            <p>{{ @$student->present_continent->name }}</p>
                        </div>
                        <div class="col-md-4 mt-3">
                            <label><b>Country:</b></label>
                            <p>{{ @$student->present_country->name }}</p>
                        </div>
                        <div class="col-md-4 mt-3">
                            <label><b>State:</b></label>
                            <p>{{ @$student->present_state->name }}</p>
                        </div>
                        <div class="col-md-4 mt-3">
                            <label><b>City:</b></label>
                            <p>{{ @$student->present_city->name }}</p>
                        </div>
