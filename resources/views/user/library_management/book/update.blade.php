...
@section('main_content')
    ...
    <div class="right_section">
        <div>
            <h4 style="color: var(--seller_text_color)">Edit Book</h4>
        </div>
    </div>
    <div class="passwodBox mb-3 col-md-12" style="background-color: var(  --seller_frontend_color); color:white">
        <form action="{{ route('teacher.library_book.update', $book->id) }}" method="POST" style="margin-top: 0%">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-sm-4 mt-3">
                    ...
                    <div class="mg-t-10 mg-sm-t-0">
                      <input type="text" name="name" style="width: 100%" class="form-control" placeholder="Enter Book Name" value="{{ $book->name }}" required>
                    </div>
                </div>
                ...
                <div class="col-sm-4 mt-3">
                  ...
                  <div class="mg-t-10 mg-sm-t-0">
                    <input type="number" name="total_set" style="width: 100%" value="{{ $book->total_set }}" class="form-control" placeholder="Enter Total Set Name" value="{{ old('total_set') }}" required>
                  </div>
              </div>
