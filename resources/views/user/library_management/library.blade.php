...
<div class="d-flex">
    ...
    <div class="" style="float:right;">
        <a href="{{ route('teacher.library_book.create') }}" class="btn btn-info"><i class="fa fa-plus"></i> Add Direction</a>

        <a href="{{ route('teacher.library_book.create') }}" class="btn btn-info"><i class="fa fa-plus"></i> Add Shelf</a>
