...
<div class="d-flex justify-content-between align-items-center">
    <h3 style="color: black">Shelves</h3>
    <div>
        <a href="{{ route('teacher.library') }}" class="btn btn-info"><i class="fa-solid fa-backward"></i> Library</a>
        <a href="{{ route('teacher.library_shelf.create') }}" class="btn btn-info"><i class="fa fa-plus"></i> Add Shelf</a>
    </div>
</div>
    ...
    <table class="table table-striped mt-3" id="datatable1" style="min-width: 800px;">
        ...
        <tbody>
            ...
            <td>
                ...
                <a href="{{ route('teacher.library_shelf.edit', $shelf->id ) }}"><i class="fa-duotone fa fa-edit"></i></a>
                &nbsp;
                <button class="btn text-danger delete-button" courseId="{{ $shelf->id }}"><i class="icon fa fa-trash tx-28"></i></button>
            ...
            <div id="delete-modal"  class="modal">
                ...
                <div class="modal-content tx-size-sm">
                    <div class="modal-body tx-center pd-y-20 pd-x-20">
                        <form action="{{ route('teacher.library_shelf.delete') }}" method="post">
                            @csrf
                            <h4 class="tx-semibold mg-b-20 mt-2 " >Are you sure! you want to delete this?</h4>
                            <input type="hidden" value="{{ $shelf->id }}" name="shelf_id" id="course_id">
