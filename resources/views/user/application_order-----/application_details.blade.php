...
@section('head')
@section('title','- Details Student Application')
...
@section('main_content')
    ...
    <div class="row card-body shadow" style="background-color: var(--seller_frontend_color);color:var(--seller_text_color)">

        <div class="col-lg-12 mt-3">
            <h2 class="text-center mb-5"><b>{{ $s_appliction->student->name }}'s Application Details</b></h2>
        ...
        <div class="col-lg-3">
            <div class="form-group">
                <label for="address"><b>{{ __('Major:') }}</b></label>
                <p>{{ @$item->major }}</p>
            </div>
        </div>
        <div class="col-lg-3">
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <button style="margin-left: 18px" type="button" data-toggle="modal" data-target="#certificateModal{{ $k }}" class="btn btn-primary"><i class="fa-solid fa-eye"></i> Details</button>
                    {{-- </div>
                    <div class="col-md-6"> --}}
                        <a href="{{ route('frontend.application-file-download', $document->id) }}" class="btn btn-primary"><i class="fa-solid fa-download"></i> Download</a>
                    </div>
                </div>
            </div>
        </div>
