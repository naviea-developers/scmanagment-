                        ...
                        <div class="row mt-4">
                            <div class="col-sm-4">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                    <input type="text" name="name" value="{{ $home_work->name }}" class="form-control" placeholder="Enter title" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                    <select name="session_id" class="form-control form-select select2">
                                        ...
                                        <option @if($session->id == $home_work->session_id)  Selected @endif value="{{ $session->id }}">{{ $session->start_year }} - {{ $session->end_year }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                    <select id="section" class="form-control form-select select2" name="section_id">
                                        ...
                                        <option @if($section->id == $home_work->section_id)  Selected @endif value="{{ $section->id }}">{{ $section->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                    <select id="lession" class="form-control form-select select2" name="lession_id">
                                        ...
                                        <option @if($lession->id == $home_work->lession_id)  Selected @endif  value="{{ $lession->id }}">{{ $lession->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                    <input type="text"  name="page_number" value="{{ $home_work->page_number }}" class="form-control" placeholder="Enter Page" required>
                                </div>
                            </div>
                            ...
                            {{-- <div class="col-sm-4 mt-3">
                                ...
                                <div class="col-sm-2 mt-3">
                                    ...
                                    <div class="align-items-center select-add-section">
                                        <a href="{{ $home_work->home_workpdf_show }}" target="_blank"><i class="fa-duotone fa fa-eye"></i></a>
                                    </div>
                                </div>
