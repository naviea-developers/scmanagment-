...
<title>Manage Credit Voucher</title>
<style>
    label{
        font-size: 1.2rem;
    }
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php
                                ...
                                ?>
                                <hr>
                                <form action="{{route('admin/save-credit-voucher')}}" method="post">
                                    @csrf
                                                ...
                                                <div class="col-sm-12 col-md-12 table-responsive">
                                                    <table class="table" id="item_table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button id="add_row"  type="button" class="btn btn-success add_row btn-sm "><i class="fa fa-plus-circle"></i> </button>
                                                            </td>
                                                        </tr>
                                                        <tr></tr>
                                                        </tbody>
