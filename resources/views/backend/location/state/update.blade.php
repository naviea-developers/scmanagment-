...
<div class="br-section-wrapper data-update">
  <h6 class="br-section-label text-center mb-4">Update State Info</h6>
    {{-- validate start  --}}
  ...
  <div class="col-xl-7 mx-auto">
      <div class="form-layout form-layout-4 py-5">
          ...
          <form id="data-form-update" action="{{ route('state.update', $state->id) }}" method="post" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row mt-3" id="menuimage">
                  ...
                  <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                      <div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 150px;">
                              <img class="display-upload-img" style="width: 150px;height: 70px;" src="{{ $state->image_show}}" alt="">
              ...
              <div class="row mt-4">
                ...
                <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                  <select id="continent"  class="form-control" name="continent_id" id="phar_cat" required>
                    ...
                    <option @if($continent->id == $state->continent_id)  Selected @endif value="{{ $continent->id }}">{{ $continent->name }}</option>
            ...
            <div class="row mt-4">
              ...
              <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                ...
                <div class="row mt-4">
                  ...
                  <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                  <input type="text" name="name" value="{{ $state->name }}" class="form-control" placeholder="Enter Package Name" required>
              </div>
              </div><!-- row -->
