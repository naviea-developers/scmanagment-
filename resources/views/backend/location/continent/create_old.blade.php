    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('continent.index')}}"> <i class="icon ion-reply text-22"></i> All Continents</a>
          </nav>
        </div><!-- br-pageheader -->

        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4"> Add New Continent</h6>
            ...
            <div class="col-xl-9 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('continent.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mt-3" id="menuimage">
                          ...
                          <div class="row mt-4">
                            ...
                            <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                            <input type="text" name="name" class="form-control" placeholder="Enter Continent Name" required>
                        </div>
                        </div><!-- row -->
                        ...
                        <div class="row mt-4">
                          <div class="col-sm-12 mg-t-10 mg-sm-t-0 text-right">
                            <a href="{{route('continent.index')}}" type="button" class="btn btn-secondary text-white mr-2" >Cancel</a>
