    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('city.index')}}"> <i class="icon ion-reply text-22"></i> All cities</a>
          </nav>
        </div><!-- br-pageheader -->

        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4"> Add New City</h6>
               {{-- validate start  --}}
               @if(count($errors) > 0)
                ...
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('city.update', $city->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3" id="menuimage">
                            <label class="col-sm-3 form-control-label">city Image: <span class="tx-danger">*</span></label>
                            <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                <div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 150px;">
                                        <img class="display-upload-img" style="width: 150px;height: 70px;" src="{{ $city->image_show}}" alt="">
                        ...
                        <div class="row mt-4">
                          ...
                          <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                            <select id="continent"  class="form-control" name="continent_id" id="phar_cat" required>
                              ...
                              <option @if($continent->id == $city->continent_id)  Selected @endif value="{{ $continent->id }}">{{ $continent->name }}</option>
                      ...
                      <div class="row mt-4">
                        ...
                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                          ...
                          <div class="row mt-4">
                            ...
                            <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                            <input type="text" name="name" value="{{ $city->name }}" class="form-control" placeholder="Enter Package Name" required>
                        </div>
                        </div><!-- row -->
                        ...
                        <div class="row mt-4">
                          <div class="col-sm-12 mg-t-10 mg-sm-t-0 text-right">
                            <a href="{{route('city.index')}}" type="button" class="btn btn-secondary text-white mr-2" >Cancel</a>
