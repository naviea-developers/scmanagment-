...
<div class="br-section-wrapper data-update">
  <h6 class="br-section-label text-center mb-4">Update Country Info</h6>
    {{-- validate start  --}}
  ...
  <div class="col-xl-10 mx-auto">
      <div class="form-layout form-layout-4 py-5">
          ...
          <form id="data-form-update" action="{{ route('country.update', $country->id) }}" method="post" enctype="multipart/form-data">
              {{-- @csrf --}}
              {{ method_field('PATCH') }}
