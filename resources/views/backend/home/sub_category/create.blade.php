    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('home-sub-category.index')}}"> <i class="icon ion-reply text-22"></i> All Sub Category</a>
          </nav>
        </div><!-- br-pageheader -->
          ...
          <div class="br-section-wrapper">
            ...
            <div class="col-xl-9 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('home-sub-category.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                <select style="height:10px" class="form-control select2" name="categorie_id">
                          ...
                          <div class="row mt-4 mt-3">
                            ...
                            <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                            <input value="{{ old('name') }}" type="text" name="name" class="form-control" placeholder="Enter Sub Category" required>
                        </div>
                        </div><!-- row -->
