                  ...
                  @if (count($sub_categories) > 0)
                    @foreach ($sub_categories as $sub_cat)
                      <tr>
                          ...
                          <td>
                            <a class="btn text-info" href="{{ route('home-sub-category.edit', $sub_cat->id) }}"><i class="icon ion-compose tx-28"></i></a>
                            <button class="btn text-danger bg-white"  value="{{$sub_cat->id}}" id="homeSubCatdelete"><i class="icon ion-trash-a tx-28"></i></button>
    ...
    <div id="homeDeleteSubCategory" class="modal fade">
        ...
        <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                <form action="{{ route('home-sub-category.delete') }}" method="post">
                    @csrf
