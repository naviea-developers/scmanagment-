    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('home-child-category.index')}}"> <i class="icon ion-reply text-22"></i> All Child Category</a>
          </nav>
        </div><!-- br-pageheader -->
          ...
          <div class="br-section-wrapper">
            ...
            <div class="col-xl-9 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('home-child-category.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mt-3">
                          <label class="col-sm-3 form-control-label">Child Category Image: <span class="tx-danger">*</span></label>
                        ...
                        <div class="row mt-3">
                          ...
                          <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                              <select style="height:10px" class="form-control select2" name="sub_category_id">
                          ...
                          <div class="row mt-4">
                            ...
                            <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                            <input value="{{ old('name') }}" type="text" name="name" class="form-control" placeholder="Enter Child Category" required>
                          </div>
                        </div><!-- row -->
                        ...
                        <div class="row mt-4">
                          <div class="col-sm-12 mg-t-10 mg-sm-t-0 text-right">
                            <a href="{{route('home-child-category.index')}}" type="button" class="btn btn-secondary text-white mr-2" >Cancel</a>
