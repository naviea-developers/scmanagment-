          ...
          <div class="br-section-wrapper">
            ...
            <div class="col-xl-9 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('home-category.update', $categorie->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PATCH') }}
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                <div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 150px;">
                                        <img class="display-upload-img" style="width: 150px;height: 70px;" src="{{ $categorie->image_show }}" alt="">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9 mg-t-10 mg-sm-t-0 mt-3">
                            <select class="form-control" name="type">
                                ...
                                <option @if($categorie->type == "home") selected @endif value="home">Course</option>
                                <option @if($categorie->type == "event") selected @endif value="event">Event</option>
                                <option @if($categorie->type == "blog") selected @endif value="blog">Blog</option>
                                <option @if($categorie->type == "master_course") selected @endif value="master_course">Master Course</option>
                                <option @if($categorie->type == "ebook") selected @endif value="ebook">Ebook</option>
                        ...
                        <div class="row mt-4">
                          ...
                          <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                            <select class="form-control" name="status">
                              <option @if($categorie->status == 1) @selected(true) @endif value="1">Active</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 mg-t-10 mg-sm-t-0 mt-3">
                                <textarea id="summernote" name="details">{!!  $categorie->details !!}</textarea>
                            </div>
                        </div><!-- row -->
