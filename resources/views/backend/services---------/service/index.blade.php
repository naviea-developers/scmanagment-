    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center">Our Service</h6>
                  ...
                  @if (count($services) > 0)
                    @foreach ($services as $service)
                      <tr>
                          <td>{{ $i++ }}</td>
                           <td>
                            <img src="{{ $service->image_show }}" alt="" width="70px" height="80px" srcset="">
                          </td>
                          <td>{{ $service->name }}</td>
                          ...
                          <td>
                            <a class="btn text-info" href="{{ route('admin.service.edit', $service->id) }}"><i class="icon ion-compose tx-28"></i></a>
                              <a class="btn text-info" href="{{ route('admin.service.item.index', $service->id) }}">Service Packages</a>
