    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4"> Add New Admin</h6>
               {{-- validate start  --}}
               @if(count($errors) > 0)
            ...
            <div class="col-xl-7 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('backendg.store_admin') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12 mt-3">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Enter Admin Name" value="{{ old('name') }}" required>
                            </div>
                            </div>
                            <div class="col-sm-12 mt-3">
