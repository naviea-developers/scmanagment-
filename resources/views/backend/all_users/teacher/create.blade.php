...
<div class="br-section-wrapper data-create" style="display: none;">
   <h6 class="br-section-label text-center mb-4"> Add New Teacher</h6>
   {{-- validate start  --}}
   ...
   <div class="col-xl-12 mx-auto">
     <div class="form-layout form-layout-4 py-5">
         ...
         <form id="data-form-create" action="{{ route('admin.teacher.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mg-t-10 mg-sm-t-0 add-data-content">
                  ...
                  <div class="d-flex align-items-center mt-2 row">
                     ...
                     <div class="col-md-1">
                        <a id="plus-btn-data-content-add" href="javascript:void(0)" class="plus-btn-data-content-add px-1 p-0 m-0 ml-2"><i class="fas fa-plus"></i></a>
                     </div>
                  </div>
