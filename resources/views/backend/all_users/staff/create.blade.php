    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('admin.staff.index')}}"> <i class="icon ion-reply text-22"></i> All Staffes</a>
          </nav>
        </div><!-- br-pageheader -->

        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4"> Add New Staff</h6>
               {{-- validate start  --}}
               @if(count($errors) > 0)
                    ...
                    <form action="{{ route('admin.staff.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            <div class="col-sm-4">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Enter Staff Name" value="{{ old('name') }}" required>
                              </div>
                            </div>
                        ...
                        <div class="row mt-3"> --}}
                            <div class="col-sm-4 mt-3">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                    <input value="{{ old('institution') }}" type="text" name="institution" class="form-control" placeholder="Enter institution name">
                                </div>
                            </div>
                            ...
                            {{-- <div class="col-sm-4 mt-3">
                                <label class=" form-control-label">Designation:</label>
                                <div class="mg-t-10 mg-sm-t-0">
                                    <input value="{{ old('designation') }}" type="text" name="designation" class="form-control" placeholder="Enter designation">
                                </div>
                            </div> --}}
                          ...
                          <div class="col-md-6">
                              ...
                              <input type="text" class="form-control mb-2 " name="instagram_id"  placeholder="Instagram URL"/>
                          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control  mb-2 " name="bank_code_ifsc"  placeholder="Bank Code/IFSC"/>
                            </div>
                            <div class="col-md-6">
                                <label class="mb-2">Account Number</label>
                                <input type="text" class="form-control  mb-2 "  name="bank_account_number"  placeholder="Account Number"/>
                            </div>
                            <div class="col-md-6">
                                <label class="mb-2">Account Holder Name</label>
                                <input type="text" class="form-control  mb-2 "  name="bank_ac_holder_name"  placeholder="Account Holder Name"/>
                            </div>
                            <div class="col-md-12">
                                <label class="mb-2">PayPal ID</label>
                                <input type="text" class="form-control  mb-2 " name="paypal_id_num"  placeholder="PayPal ID"/>
                            </div>
                        ...
                        <div class="mg-t-10 mg-sm-t-0 add-data-content">
                            ...
                            <div class="d-flex align-items-center mt-2 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex  align-items-center select-add-section">
                                        <input type="file" accept="image/jpeg,image/gif,image/png,application/pdf" name="certificates_file[]" value="{{ old('$certificates_file') }}" class=" form-control">
                                    </div>
                                </div>
                    ...
                    <hr>
                        <div class="row mt-3">
                          <div class="col-sm-12 mg-t-10 mg-sm-t-0 text-right">
                            <a href="{{route('admin.staff.index')}}" type="button" class="btn btn-secondary text-white mr-2" >Cancel</a>
