                ...
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('admin.staff.update', $staff->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mt-4">
                            ...
                            {{-- <div class="col-sm-4">
                                <label class=" form-control-label">staff Type:</label>
                                <select  class="form-control" name="staff_type" required>
                                    <option value="">Select Gender</option>
                                    <option @if ($staff->staff_type == 'permanent') Selected @endif value="permanent">Permanent</option>
                                    <option @if ($staff->staff_type == 'guest') Selected @endif value="guest">Guest</option>
                                </select>
                            </div> --}}
                        ...
                        <div class="row mt-4"> --}}
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                    ...
                                    {{-- <input value="{{ $staff->language}}" type="text" name="language" class="form-control" placeholder="Enter language"> --}}
                                </div>
                            </div>
                        ...
                        <div class="row mt-4"> --}}
                            ...
                            {{-- <div class="col-sm-4 mt-3">
                                <label class=" form-control-label">Designation:</label>
                                <div class="mg-t-10 mg-sm-t-0">
                                    <input value="{{ $staff->designation }}" type="text" name="designation" class="form-control" placeholder="Enter designation">
                                </div>
                            </div> --}}
                            ...
                            {{-- <div class="col-sm-4 mt-3">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                    <input @if ( $staff->is_librarian == 1) checked @endif type="checkbox" name="is_librarian" value="1">
                                </div>
                             </div> --}}
