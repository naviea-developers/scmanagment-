    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('admin.selery.index')}}"> <i class="icon ion-reply text-22"></i> All Selery</a>
          </nav>
        </div><!-- br-pageheader -->

        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4"> Add New Seller</h6>
               {{-- validate start  --}}
               @if(count($errors) > 0)
            ...
            <div class="col-xl-12 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('admin.selery.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-4">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Enter Seller Name" value="{{ old('name') }}" required>
                            </div>
                            </div>
                            <div class="col-sm-4">
