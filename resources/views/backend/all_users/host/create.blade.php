    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('admin.host.index')}}"> <i class="icon ion-reply text-22"></i> All Instrutor</a>
          </nav>
        </div><!-- br-pageheader -->

        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4"> Add New Host</h6>
               {{-- validate start  --}}
               @if(count($errors) > 0)
                    ...
                    <form action="{{ route('admin.host.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-4">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Enter Host Name" value="{{ old('name') }}" required>
                            </div>
                            </div>
                            <div class="col-sm-4">
