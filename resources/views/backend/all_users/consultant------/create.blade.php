    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4"> Add New Consultant</h6>
               {{-- validate start  --}}
               @if(count($errors) > 0)
                    ...
                    <form action="{{ route('admin.consultant.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                <input type="text" name="name" class="form-control" placeholder="Enter Consultant Name" value="{{ old('name') }}" required>
                            </div>
                            </div>
