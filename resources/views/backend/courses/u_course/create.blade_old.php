    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('admin.course.index')}}"> <i class="icon ion-reply text-22"></i> All Course</a>
          </nav>
        </div><!-- br-pageheader -->

        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4"> Add New Course</h6>
            {{-- validate start  --}}
                ...
                <div class="form-layout form-layout-4">
                    ...
                    <form action="{{ route('admin.course.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row ">
                            ...
                            <div id="generalCourseCategoryFields" class="courseFields">
<div class="row">
                    ...
                    <div id="generalCourseFields" class="courseFields">
                        ...
                        {{-- <div class="row mt-4">
                            ...
                            <div class="col-sm-4">
                                <label class="form-control-label"><b>Child Category :</b><span class="tx-danger">*</span></label>
                                <div class="mg-t-10 mg-sm-t-0">
                                    <select id="childCat"  class="form-control" name="general_child_category_id">
                                        <option value="">Select Child category</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-4 mt-3">
                                <label class="form-control-label"><b>Pro Child Category :</b><span class="tx-danger">*</span></label>
                                <div class="mg-t-10 mg-sm-t-0">
                                    <select id="proChildCat"  class="form-control" name="general_pro_child_category_id">
                                        <option value="">Select Pro Child category</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="d-flex mt-3">
                                <div class="" style="border: 1px solid;padding:10px;width: 97%;">
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input  value="" type="text" name="capter_name[0]" class="form-control" placeholder="Enter Capter Name">
                                        </div>
                                        <hr style="width:95%;">
                                    </div>
                        ...
                        <h4>Chapter Name:</h4>
                        {{-- Pre questions start --}}
                        {{-- <div class="show-add-question-data-chapter">
                            <div class="d-flex mt-3">
                                <div class="" style="border: 1px solid;padding:10px;width: 97%;">
                                    <div class="row mt-3">

                                        <div class="col-sm-9">
                                            <input  value="" type="text" name="capter_question_name[0]" class="form-control" placeholder="Enter Capter Name">
                                        </div>
                                        <hr style="width:95%;">
                                    </div>

                                    <div class="show-add-list-data-question">
                                        <div class="row mt-3">
                                            <label class="col-sm-3 form-control-label"> </label>
                                            <div class="col-sm-12 mg-t-10 mg-sm-t-0">
                                                <div class="d-flex align-items-center ">
                                                    <input  value="" type="text" name="question_names[0][]" class="form-control mr-2" placeholder="Enter question">
                                                    <a question_id="0" href="javascript:void(0)" class="plus-btn-data-question plus-btn-data px-1 p-0 m-0 ml-2"><i class="fas fa-plus"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <a id="plus-btn-data-question-chapter" href="javascript:void(0)" class="plus-btn-data-question-chapter px-1 p-0 m-0 ml-2"><i class="fas fa-plus"></i></a>
                            </div>
                        </div> --}}
                       {{-- Pre questions End --}}
                    ...
                    <label class="mt-5">
                        <input type="checkbox" name="is_exam" value="1" id="checkButton"> Examination?
                      </label>
                    ...
                    <div id="inputFields" style="display: none;">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="total_question" name="total_question" placeholder="Total Questions">
                            </div>
                            <div class="col-md-6">
                                <label>Each Question Marks: </label>
                                <input type="text" id="each_question_marks" name="each_question_marks" placeholder="Each Question Marks">
                            </div>
                        </div>
                      </div>
...
<script>
    function showCourseFields() {
      ...
      var generalCourseCategoryFields = document.getElementById("generalCourseCategoryFields");
      ...
      if (selectedValue === "0") {
        ...
        generalCourseCategoryFields.style.display = "block";
        masterCourseFields.style.display = "none";
      } else {
        generalCourseFields.style.display = "none";
        generalCourseCategoryFields.style.display = "none";
...
//question start
 var question =1;
    $(document).on('click','.plus-btn-data-question',function(){
        let out = '<div class="row mt-3">'+
'                                            <label class="col-sm-3 form-control-label"> </label>'+
'                                            <div class="col-sm-12 mg-t-10 mg-sm-t-0">'+
'                                                <div class="d-flex align-items-center ">'+
'                                                    <input  value="" type="text" name="question_names['+$(this).attr('question_id')+'][]" class="form-control mr-2" placeholder="Enter question">'+
'                                                    <a href="javascript:void(0)" class="minus-btn-data-question px-1 p-0 m-0 ml-2"><i class="fas fa-minus-circle"></i></a>'+
'                                                </div>'+
'                                            </div>'+
'                                        </div>';
    ...
    $(document).on('click','.minus-btn-data-question',function(){
    ...
    $('#plus-btn-data-question-chapter').on('click',function(){
...
''+
'                                        <div class="col-sm-9">'+
'                                            <input  value="" type="text" name="capter_question_name['+question+']" class="form-control" placeholder="Enter Capter Name">'+
'                                        </div>'+
'                                        <hr style="width:95%;">'+
'                                    </div>'+
''+
...
'                                            <div class="col-sm-12 mg-t-10 mg-sm-t-0">'+
'                                                <div class="d-flex align-items-center ">'+
'                                                    <input  value="" type="text" name="question_names['+question+'][]" class="form-control mr-2" placeholder="Enter question">'+
'                                                    <a question_id="'+question+'" href="javascript:void(0)" class="plus-btn-data-question plus-btn-data px-1 p-0 m-0 ml-2"><i class="fas fa-plus"></i></a>'+
'                                                </div>'+
'                                            </div>'+
'                                        </div>'+
'                                    </div>'+
''+
'                                </div>'+
'                               <a href="javascript:void(0)" class="minus-btn-data-chapter px-1 p-0 m-0 ml-2"><i class="fas fa-minus-circle"></i></a>'+
'                            </div>';


        $('.show-add-question-data-chapter').prepend(myvar);
        question++;
        $(this).focus();
    });
    $(document).on('click','.minus-btn-data-chapter',function(){
        $(this).parent().remove();
    });
