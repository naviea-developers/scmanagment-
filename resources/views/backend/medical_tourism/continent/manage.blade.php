    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
            ...
            <div class="br-section-wrapper data-list pt-3">
                ...
                <h6 class="br-section-label text-center">All Continents</h6>
        ...
        <div class="modal-dialog modal-dialog-top" role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-body tx-center pd-y-20 pd-x-20">
                    <form id="data-form-delete" action="{{ route('admin.continent.delete') }}" method="post">
                        @csrf
...
<script>
    ...
    var datatable = $('#data_table_list').DataTable({
       ...
       "order": [[ 0, "desc" ]],
        ...
        "serverSide": true,
        "ajax":{
            "url": "{{ route('admin.continent.ajax') }}",
            "dataType": "json",
            "type": "POST",
            data: function(data){
