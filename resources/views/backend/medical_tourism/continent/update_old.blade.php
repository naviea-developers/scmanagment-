    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('continent.index')}}"> <i class="icon ion-reply text-22"></i> All Continent</a>
          </nav>
        </div><!-- br-pageheader -->
          ...
          <div class="br-section-wrapper">
            ...
            <div class="col-xl-9 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('continent.update', $continent->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
