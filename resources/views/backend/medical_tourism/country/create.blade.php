...
<div class="br-section-wrapper data-create" style="display: none;">
  ...
  <div class="col-xl-7 mx-auto">
    <div class="form-layout form-layout-4 py-5">
      ...
      <form id="data-form-create" action="{{ route('admin.bulding.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-sm-12 ">
                <label class="form-control-label">Bulding Name: <span class="tx-danger">*</span></label>
                <div class="mg-t-10 mg-sm-t-0">
                    <input type="text" name="name" class="form-control" placeholder="Enter Bulding Name" value="{{ old('name') }}">
                </div>
            </div>
        </div>
        <div class="row mt-3">
