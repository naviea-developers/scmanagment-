          ...
          <div class="br-section-wrapper">
            ...
            <div class="col-xl-7 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('phar-category.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mt-3">
                        ...
                        <div class="row mt-4">
                          <div class="col-sm-12 mg-t-10 mg-sm-t-0 text-right">
                            <a href="{{route('phar-category.index')}}" type="button" class="btn btn-secondary text-white mr-2" >Close</a>
