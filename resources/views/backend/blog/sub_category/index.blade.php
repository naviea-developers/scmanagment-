    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center">Sub Category</h6>
                  ...
                  @if (count($sub_categories) > 0)
                    @foreach ($sub_categories as $sub_cat)
                      <tr>
                          ...
                          <td>
                            <a class="btn text-info" href="{{ route('phar-sub-category.edit', $sub_cat->id) }}"><i class="icon ion-compose tx-28"></i></a>
                            <button class="btn text-danger bg-white"  value="{{$sub_cat->id}}" id="homeCatdelete"><i class="icon ion-trash-a tx-28"></i></button>
    ...
    <div id="homeDeleteCategory" class="modal fade">
        ...
        <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                <form action="{{ route('phar-sub-category.delete') }}" method="post">
                    @csrf
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
