    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4">Update Topic</h6>
            @if(count($errors) > 0)
            ...
            <div class="col-xl-7 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('blog.update_topic', $topic->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mt-4">
                          ...
                          <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                            <select class="form-control select2" name="status">
                              <option @if($topic->status == 1) @selected(true) @endif value="1">Active</option>
                              <option @if($topic->status == 0) @selected(true) @endif value="0">Inactive</option>
                          </select>
                          </div>
                        </div><!-- row -->
