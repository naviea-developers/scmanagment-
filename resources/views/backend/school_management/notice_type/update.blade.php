...
<div class="br-section-wrapper data-update">
  <h6 class="br-section-label text-center mb-4">Update Notice Type Info</h6>
    {{-- validate start  --}}
  ...
  <div class="col-xl-7 mx-auto">
      <div class="form-layout form-layout-4 py-5">
          ...
          <form id="data-form-update" action="{{ route('admin.notice_type.update', $noticeType->id) }}" method="post" enctype="multipart/form-data">
              @csrf
