    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            ...
            @endif
            {{-- success message End --}}
            <a style="margin-bottom: 20px" href="{{ route('admin.class_duration.create') }}" class="btn btn-primary btn-sm float-right">
    ...
    <div id="datamodalshow" class="modal fade">
        ...
        <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                <form action="{{ route('admin.class_duration.delete') }}" method="post">
                    @csrf
