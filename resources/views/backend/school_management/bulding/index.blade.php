    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            ...
            <a style="margin-bottom: 20px" href="{{ route('admin.bulding.create') }}" class="btn btn-primary btn-sm float-right">
                  ...
                  @if (count($buldings) > 0)
                    @foreach ($buldings as $bulding)
                      <tr>
                          ...
                          <td>
                            @if(@$bulding->status == 0)
                            <a href="{{ route('admin.bulding.status',$bulding->id) }}" class="btn btn-sm btn-warning">Inactive</a>
                            @elseif(@$bulding->status == 1)
                            <a href="{{ route('admin.bulding.status',$bulding->id) }}" class="btn btn-sm btn-success">Active</a>
                            @endif
                          </td>
                          <td>
    ...
    <div id="datamodalshow" class="modal fade">
        ...
        <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                <form action="{{ route('admin.bulding.delete') }}" method="post">
                    @csrf
