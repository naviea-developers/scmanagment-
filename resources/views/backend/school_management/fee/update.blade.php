          ...
          <div class="br-section-wrapper">
            ...
            <div class="col-xl-7 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('admin.fee.update', $fee->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                      ...
                      {{-- <div class="row">
                          <div class="col-sm-12">
                              ...
                              <div class="mg-t-10 mg-sm-t-0">
                                  <input type="text" name="particular_duration" class="form-control" placeholder="Enter Particular Duration" value="{{ $fee->particular_duration }}" required>
                              </div>
                          </div>
                      </div> --}}
                      {{-- <div class="row">
