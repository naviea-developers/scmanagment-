            ...
            <div class="br-section-wrapper data-list pt-3">
                ...
                <div style="text-align: right;">
                    <a style="margin-bottom: 20px" href="javascript:void(0);" class="btn btn-primary btn-sm btn-new">
                        <i class="fa fa-plus"></i> Add Daily Class Video
                    </a>
                </div>
                    ...
                    <table id="data_table_list" class="table display responsive nowrap">
                        <thead>
                            <tr>
                                ...
                                <th scope="wd-10p">Title</th>
                                <th scope="wd-10p">Teacher Name</th>
                                <th scope="wd-10p">Class Name</th>
                                <th scope="wd-10p">Subject</th>
                                <th scope="wd-10p">Lession</th>
                                <th scope="wd-10p">Page Number</th>
        ...
        <div class="modal-dialog modal-dialog-top" role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-body tx-center pd-y-20 pd-x-20">
                    <form id="data-form-delete" action="{{ route('admin.daily_class.delete') }}" method="post">
                        @csrf
                        ...
                        <input type="hidden" name="daily_class_id" id="modal_data_id">
...
<script>
    ...
    var datatable = $('#data_table_list').DataTable({
       ...
       "order": [[ 0, "desc" ]],
        ...
        "serverSide": true,
        "ajax":{
            "url": "{{ route('admin.daily_class.ajax') }}",
            "dataType": "json",
            "type": "POST",
            data: function(data){
