    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          ...
          <div class="br-section-wrapper">
            ...
            <a style="margin-bottom: 20px" href="{{ route('admin.subject.create') }}" class="btn btn-primary btn-sm float-right">
                    ...
                    @foreach ($rooms as $room)
                      <tr>
                          ...
                          <td>
                            ...
                            <a href="{{ route('admin.room.status',$v->id) }}" class="btn btn-sm btn-success">Active</a>
                            @endif
                          </td>
                          <td>
