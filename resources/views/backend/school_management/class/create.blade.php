...
<div class="br-section-wrapper data-create" style="display: none;">
  <h6 class="br-section-label text-center mb-4"> Add New class</h6>
  {{-- validate start  --}}
  ...
  <div class="col-xl-7 mx-auto">
    <div class="form-layout form-layout-4 py-5">
      ...
      <form id="data-form-create" action="{{ route('admin.class.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row mt-4">
          <div class="col-sm-12">
              ...
              <div class="mg-t-10 mg-sm-t-0">
                  <textarea id="summernote_three" name="daily_class_details">{{ old('daily_class_details') }}</textarea>
              </div>
          </div>
        </div>
