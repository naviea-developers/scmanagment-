...
@section('main_contain')
    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
            @include('Backend.school_management.exam_class.create')

            <div class="br-section-wrapper data-list pt-3">

                <h6 class="br-section-label text-center">All Exam Subject</h6>
                <div style="text-align: right;">
                    <a style="margin-bottom: 20px" href="javascript:void(0);" class="btn btn-primary btn-sm btn-new">
                        <i class="fa fa-plus"></i> Add Exam Subject
                    </a>
                </div>
                    ...
                    <table id="data_table_list" class="table display responsive nowrap">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-10p">Exam Title</th>
                                <th class="wd-10p">Class Name</th>
                                <th class="wd-10p">Subject</th>
                                <th class="wd-10p">Exam Type</th>
        ...
        <div class="modal-dialog modal-dialog-top" role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-body tx-center pd-y-20 pd-x-20">
                    <form id="data-form-delete" action="{{ route('admin.examclass.delete') }}" method="post">
                        @csrf
...
<script>
    ...
    var datatable = $('#data_table_list').DataTable({
       ...
       "order": [[ 0, "desc" ]],
        ...
        "serverSide": true,
        "ajax":{
            "url": "{{ route('admin.examclass.ajax') }}",
            "dataType": "json",
            "type": "POST",
            data: function(data){
