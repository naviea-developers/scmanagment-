...
@section('main_contain')
    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          @include('Backend.school_management.lession.create')

            <div class="br-section-wrapper data-list pt-3">

                <h6 class="br-section-label text-center">All Lession</h6>
        ...
        <div class="modal-dialog modal-dialog-top" role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-body tx-center pd-y-20 pd-x-20">
                    <form id="data-form-delete" action="{{ route('admin.lession.delete') }}" method="post">
                        @csrf
