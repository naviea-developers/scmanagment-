    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('admin.academic_year.index')}}"> <i class="icon ion-reply text-22"></i> All Academic Years</a>
          </nav>
        </div><!-- br-pageheader -->
          ...
          <div class="br-section-wrapper">
            ...
            <div class="col-xl-7 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('admin.academic_year.update', $year->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mt-3">
                          <div class="col-sm-12 mg-t-10 mg-sm-t-0 text-right">
                            <a href="{{route('admin.academic_year.index')}}" type="button" class="btn btn-secondary text-white mr-2" >Cancel</a>
