@section('title')
Admin - Student Info Update List
@endsection
    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center">All Student Update List</h6>
                  ...
                  @if (count($students) > 0)
                    @foreach ($students as $student)
                      <tr class="text-center">
                          ...
                          <td>
                            @if(@$student->status == 0)
                            <p class="btn btn-sm btn-warning"><i class="fa-solid fa-hourglass-half"></i> Pending</p>
                            @elseif(@$student->status == 1)
                            <p class="btn btn-sm btn-success"><i class="fa-solid fa-check"></i> Updated</p>
                            @endif
                          </td>
                          <td>
    ...
    <div id="datamodalshow" class="modal fade">
        ...
        <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                <form action="{{ route('admin.student_info_update.delete') }}" method="post">
                    @csrf
