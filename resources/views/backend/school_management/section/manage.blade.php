...
@section('main_contain')
    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          @include('Backend.school_management.section.create')
      ...
      <div class="modal-dialog modal-dialog-top" role="document">
          <div class="modal-content tx-size-sm">
              <div class="modal-body tx-center pd-y-20 pd-x-20">
                  <form id="data-form-delete" action="{{ route('admin.school_section.delete') }}" method="post">
                      @csrf
...
<script>
    ...
    var datatable = $('#data_table_list').DataTable({
       ...
       "order": [[ 0, "desc" ]],
        ...
        "serverSide": true,
        "ajax":{
            "url": "{{ route('admin.school_section.ajax') }}",
            "dataType": "json",
            "type": "POST",
            data: function(data){
