...
<div class="br-mainpanel">
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4"> Make Marksheet</h6>
            ...
            <div class="col-xl-12 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('admin.marksheet.show') }}" method="post" enctype="multipart/form-data">
                        @csrf
            ...
            <div class="row mt-3">
                <div class="col-sm-12 mg-t-10 mg-sm-t-0 text-center">
                    <button type="submit" class="btn btn-info ">Make Admit Card</button>
                </div>
            </div>
            </form>
