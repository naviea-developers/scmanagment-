    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('admin.group.index')}}"> <i class="icon ion-reply text-22"></i> All Groups</a>
          </nav>
        </div><!-- br-pageheader -->

        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4">Update Group Info</h6>
             {{-- validate start  --}}
             @if(count($errors) > 0)
                    ...
                    <form action="{{ route('admin.group.update', $group->id) }}" method="post" enctype="multipart/form-data">
                          ...
                          <div class="col-sm-12">
                            ...
                            <div class="mg-t-10 mg-sm-t-0">
                              <select name="class_id" class="form-control">
                                ...
                                <option  @if($class->id == $group->class_id)  Selected @endif value="{{ $class->id }}">{{ $class->name }}</option>
                                @endforeach
                              </select>
                            </div>
                          </div>
                            ...
                            <div class="col-sm-12 mt-3">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                <input type="text" name="name" class="form-control" placeholder="Enter Group Name" value="{{ $group->name }}" required>
                            </div>
                            </div>
                        ...
                        <div class="row mt-3">
                          <div class="col-sm-12 mg-t-10 mg-sm-t-0 text-right">
                            <a href="{{route('admin.group.index')}}" type="button" class="btn btn-secondary text-white mr-2" >Cancel</a>
