    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4"> Add New Gallery Image</h6>
               {{-- validate start  --}}
               @if(count($errors) > 0)
                        ...
                        <div class="row">
                            <div class="col-sm-12 ">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                    <input type="text" name="name" class="form-control" placeholder="Enter image Name" value="{{ old('name') }}">
                                </div>
                            </div>
                        </div>
