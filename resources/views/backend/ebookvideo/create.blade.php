    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('admin.ebookvideo.index')}}"> <i class="icon ion-reply text-22"></i> All Ebook Video</a>
          </nav>
        </div><!-- br-pageheader -->

        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4"> Add New Ebook Video</h6>
               {{-- validate start  --}}
               @if(count($errors) > 0)
            ...
            <div class="col-xl-12 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('admin.ebookvideo.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-sm-4 mt-3">
                              ...
                              <div class="col-sm-6 mt-3">
                                <label class="form-control-label"><b>Related E-Video :</b></label>
                                <div class="mg-t-10 mg-sm-t-0">
                                    <select class="form-control multipleSelect2Search custom-select" name="relatedebook_id[]" multiple>
                                      <option value="">select related e-video</option>
