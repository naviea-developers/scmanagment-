    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('admin.university.index')}}"> <i class="icon ion-reply text-22"></i> All University</a>
          </nav>
        </div><!-- br-pageheader -->

        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4"> Add New University</h6>
               {{-- validate start  --}}
               @if(count($errors) > 0)
            ...
            <div class="col-xl-12 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('admin.university.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row ">
                            <div class="col-sm-4" >
                                <label class="form-control-label">University Icon: <span class="tx-danger">*</span></label>
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-4">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Enter University Name" value="{{ old('name') }}" required>
                                </div>
                            </div>
