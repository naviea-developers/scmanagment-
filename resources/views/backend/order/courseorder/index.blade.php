                    ...
                    @foreach ($orders as $k => $order)
                      <tr>
                         ...
                         @endif
                          ...
                          <td>
                            <button class="btn text-success bg-white"  value="{{$order->id}}" data-toggle="modal" data-target="#datamodalshow{{ $k }}"><i class="icon ion-compose tx-28"></i></button>
                      ...
                      <div id="datamodalshow{{ $k }}" class="modal fade">
