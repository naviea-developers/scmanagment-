          ...
          <div class="br-section-wrapper">
            ...
            <div class="col-xl-11 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('all-pages.store') }}" method="post">
                        @csrf
                        {{-- <div class="row mb-3">
                        ...
                        <div class="row">
                         ...
                         <div class="row mt-3">
                            ...
                            <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                <textarea type="text" id="summernote" name="description" class="form-control" placeholder="Enter Description" required></textarea>
                            </div>
                        </div><!-- row -->
                         <div class="row mt-3">
                            ...
                            <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                <select style="height:10px" class="form-control select2" name="template">
                                    <option value="">Select Sub Template</option>
