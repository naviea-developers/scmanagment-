    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4"> FAQ Content Setup</h6>
            @if(count($errors) > 0)
            ...
            <div class="col-xl-12 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('admin.faq_setup') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mt-4 mb-4">
                            ...
                            <div class="col-sm-3 mt-4 mg-t-10 mg-sm-t-0">
                                <div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 150px;">
                                    <img class="display-upload-img" style="width: 150px;height: 70px;" src="{{ $faq_content->banner_image_show }}" alt="">
                        ...
                        <div class="row mt-4 mb-4">
                            <div class="col-sm-12">
                                ...
                                <input  type="text" name="title1" value="{{ $faq_content->title1 ?? '' }}" class="form-control" placeholder="Enter Banner Title">
                                </div>
                            </div>
                            <div class="col-sm-12 mt-4">
                                <label class=" form-control-label">Banner Descriprion:<span class="tx-danger"></span></label>
                                <div class="mg-t-10 mg-sm-t-0">
                                <textarea  type="text" name="description1" class="form-control" placeholder="Enter Banner Text">{{ $faq_content->description1 ?? '' }}</textarea>
                                </div>
                            </div>
                            <hr>
                        </div>
                        <div class="row mt-4 mb-4">
                            <div class="col-sm-12">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                <input  type="text" name="title2" value="{{ $faq_content->title2 ?? '' }}" class="form-control" placeholder="Enter Banner Title">
                                </div>
                            </div>
                            <div class="col-sm-12 mt-4">
                                <label class=" form-control-label">Page Descriprion:<span class="tx-danger"></span></label>
                                <div class="mg-t-10 mg-sm-t-0">
                                <textarea  type="text" name="description2" class="form-control" placeholder="Enter Banner Text">{{ $faq_content->description2 ?? '' }}</textarea>
                                </div>
                            </div>
                            <hr>
                        </div>
