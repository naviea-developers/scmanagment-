                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7 mg-t-10 mg-sm-t-0">
                                                    <div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 76px;">
                                                        <img class="display-upload-img" style="width: 76px;height: 70px;" src="{{ asset('public/upload/paymentgateway/'.$datalist['stripe_icon']) }}" alt="">
								...
								<h3 style="margin-left: 10px" class="mb-3">Paypal</h3>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7 mg-t-10 mg-sm-t-0">
                                                <div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 76px;">
                                                    <img class="display-upload-img" style="width: 76px;height: 70px;" src="{{ asset('public/upload/paymentgateway/'.$datalist['paypal_icon']) }}" alt="">
