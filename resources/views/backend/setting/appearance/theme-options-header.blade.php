				...
				<div class="card">
					...
					<div class="card-body tabs-area p-0" style="background-color:var(--theme_color); height:auto">
						...
						<div class="tabs-body">
							...
							{{-- success message start --}}
							<!--Data Entry Form-->
							<form novalidate="" action="{{ route('backend.save-theme-header') }}" method="POST" data-validate="parsley" id="DataEntry_formId">
								@csrf
							 <div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											<label for="address">{{ __('Company Name') }}</label>
											<input value="{{ $results['company_name'] }}" type="text" name="company_name" id="address" class="form-control">
										</div>
									</div>
								</div>
