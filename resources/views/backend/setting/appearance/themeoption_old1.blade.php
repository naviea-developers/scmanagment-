				...
				<div class="card">
					...
					<div class="card-body tabs-area p-0" style="background-color: var(--theme_color); height:auto">
						...
						<div class="tabs-body">
							...
							<form id="DataEntry_formId" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
									{{-- < class="col-lg-8"> --}}
									<div class="col-sm-4">
										<div class="form-group">
											...
											<div id="color_brand_picker" class="input-group tw-picker">
												<input name="header_color" id="header_color" type="color" value="{{ $datalist['header_color'] == '' ? '#07477D' : $datalist['header_color'] }}" class="form-control"/>
												<span class="input-group-addon"><i></i></span>
											</div>
                                            <button type="submit" id="save-button" class="btn blue-btn btn-info mt-1">Save</button>
										</div>
									</div>
									<div class="col-sm-4">
                                        <div class="form-group">
											...
											<div id="color_brand_picker" class="input-group tw-picker">
												<input name="header_text_color" id="header_text_color" type="color" value="{{ $datalist['header_text_color'] == '' ? '#07477D' : $datalist['header_text_color'] }}" class="form-control"/>
												<span class="input-group-addon"><i></i></span>
											</div>
                                            <button type="submit" id="save-button" class="btn blue-btn btn-info mt-1">Save</button>
										</div>
									...
									<div class="col-sm-4">
										<div class="form-group">
											...
											<div id="color_brand_dark_picker" class="input-group tw-picker">
												<input name="menu_color" id="menu_color" type="color" value="{{ $datalist['menu_color'] == '' ? '#212529' : $datalist['menu_color'] }}" class="form-control"/>
												<span class="input-group-addon"><i></i></span>
											</div>
                                            <button type="submit" id="save-button" class="btn blue-btn btn-info mt-1">Save</button>
										</div>
...
<script>
    document.getElementById('save-button').addEventListener('click', function() {
        ...
        fetch('{{ route('backend.theme-options-color-save') }}', {
            method: 'POST',
            headers: {
