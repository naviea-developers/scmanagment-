    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4"> Update Clinic</h6>
               {{-- validate start  --}}
            ...
            <div class="col-xl-12 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('admin.e_clinic.update',$clinic->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mt-3">
                            <div class="col-sm-12">
                                <label class="form-control-label">Clinic Image: <span class="tx-danger">*</span></label>
                                <div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 150px;">
                                    <img class="display-upload-img" style="width: 150px;height: 70px;" src="{{ $clinic->image_show }}" alt="">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="mg-t-10 mg-sm-t-0">
                                <select id="continent"  class="form-control" name="continent_id">
                                    ...
                                    <option @if($continent->id == $clinic->continent_id) selected @endif value="{{ $continent->id }}">{{ $continent->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            </div>
                            ...
                            <div class="mg-t-10 mg-sm-t-0">
                                <select  class="form-control" name="country_id" id="country">
                                    ...
                                    <option  @if($country->id == $clinic->country_id) selected @endif value="{{ $country->id }}">{{ $country->name }}</option>
                                    @endforeach
                                  </select>
                            </div>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                    <select  class="form-control" name="state_id" id="state">
                                        ...
                                        <option @if($state->id == $clinic->state_id) selected @endif value="{{ $state->id }}">{{ $state->name }}</option>
                                        @endforeach
                                      </select>
                                </div>
                                </div>
                            <div class="col-sm-4">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                    <select  class="form-control" name="city_id" id="city">
                                        ...
                                        <option @if($city->id == $clinic->city_id) selected @endif value="{{ $city->id }}">{{ $city->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                    <select  class="form-control" name="post" id="post">
                                        ...
                                        <option @if($thana->id == $clinic->thana_id) selected @endif value="{{ $thana->id }}">{{ $thana->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                    <select  class="form-control" name="union" id="union">
                                        ...
                                        <option @if($union->id == $clinic->union_id) selected @endif value="{{ $union->id }}">{{ $union->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                    <select  class="form-control" name="word" id="word">
                                        ...
                                        <option @if($word->id == $clinic->word_id) selected @endif value="{{ $word->id }}">{{ $word->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-4">
                                ...
                                <div class="mg-t-10 mg-sm-t-0">
                                    <input type="text" name="name" class="form-control" placeholder="Enter Clinic Name" value="{{ old('name') ?? $clinic->name }}" required>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <label class="form-control-label">Mobile Number: <span class="tx-danger">*</span></label>
                                <div class="cmg-t-10 mg-sm-t-0">
                                    <input type="number" name="mobile" class="form-control" placeholder="Enter Mobile Number" value="{{ old('mobile') ?? $clinic->mobile }}">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <label class="form-control-label">Email: <span class="tx-danger">*</span></label>
                                <div class="mg-t-10 mg-sm-t-0">
                                    <input type="email" name="email" class="form-control" placeholder="Enter Email" value="{{ old('email') ?? $clinic->email }}">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <label class="form-control-label">Address: <span class="tx-danger">*</span></label>
                                <div class="mg-t-10 mg-sm-t-0">
                                    <input type="text" name="address" class="form-control" placeholder="Enter Address"  value="{{ old('address') ?? $clinic->address }}">
                                </div>
                            </div>
                        ...
                        <div class="row mt-3">
                          <div class="col-sm-12 mg-t-10 mg-sm-t-0 text-right">
                            <a href="{{route('admin.e_clinic.index')}}" type="button" class="btn btn-secondary text-white mr-2" >Cancel</a>
