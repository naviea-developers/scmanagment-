    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center">Nurse Service Packages</h6>
            ...
            <div class="mb-3 d-flex justify-content-end">
                ...
                <a href="{{ route('admin.nurse_service.banner') }}" class="btn btn-info tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium">
                    {{-- <i class="fa fa-plus ml-0 mr-1"></i> --}}
                    Service Banner</a>
                <a href="" class="btn btn-info tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium ml-2">
                    {{-- <i class="fa fa-plus ml-0 mr-1"> --}}
                        </i>Nourse List</a>
            </div>
