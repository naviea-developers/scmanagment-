    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center"> All Customers</h6>
                  ...
                  @if (count($customers) > 0)
                    @foreach ($customers as $customer)
                      <tr>
                          ...
                          <td>
                            <a class="btn text-info" href="{{ route('admin.customer_user.edit', $customer->id) }}"><i class="icon ion-compose tx-28"></i></a>
                            <button class="btn text-danger bg-white"  value="{{$customer->id}}" id="homeCatdelete"><i class="icon ion-trash-a tx-28"></i></button>
                            <button class="btn text-white bg-info changePass"  value="{{$customer->id}}">Change Password</button>
                          </td>
                      </tr>
                    @endforeach
                  @endif
    ...
    <div id="homeDeleteCategory" class="modal fade">
        ...
        <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                <form action="{{ route('admin.customer_user.delete') }}" method="post">
                    @csrf
    ...
    <div id="changePassword" class="modal fade">
      ...
      <div class="modal-content tx-size-sm">
          <div class="modal-bodypd-y-20 pd-x-20 p-4">
              <form action="{{ route('admin.customer_user.change_password') }}" method="post">
                  @csrf
