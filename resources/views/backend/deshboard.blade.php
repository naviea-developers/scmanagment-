...
@section('content')
    ...
    <div class="br-mainpanel">
        <div class="br-pagetitle" style="padding-top: 85px;">
        ...
        <div class="br-pagebody">
             ...
             <div clas="tabsForReprot" style="position: relative;">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist"  style="position: absolute;left: 50%;top: 0;transform: translate(-50%, 0px);">
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="contact-tab" data-toggle="tab" data-target="#year" type="button" role="tab" aria-controls="contact" aria-selected="false">This Year</button>
              </li>
            </ul>
                      ...
                      <div class="row row-sm">
                        <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    <i class="fa-duotone fa-list-ul tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Today Visited</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $visitor1->count() }}</p>
                                    </div>
                                </div>
                       ...
                       <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-secondary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    <i class="fa-duotone fa-user tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Today User</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $user1->count() }}</p>
                                    </div>
                                </div>
                       ...
                       <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    <i class="fa-duotone fa-cart-shopping tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Today Sale</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $cart1->count() }}</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    <i class="fa-duotone fa-screen-users tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Today Classes</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $classes1->count() }}</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    <i class="fa-duotone fa-book tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Today Course</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $course1->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch1" class="ht-50 tr-y-1"></div>
                            </div>
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    ...
                                    <i class="fa-duotone fa-person-chalkboard tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Teacher</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $teacher1->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch1" class="ht-50 tr-y-1"></div>
                            </div>
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    ...
                                    <i class="fa-duotone fa-child tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Student's</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $student1->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch1" class="ht-50 tr-y-1"></div>
                            </div>
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    ...
                                    <i class="fa-duotone fa-calendar-circle-user tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Attendance</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $teacher1->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch1" class="ht-50 tr-y-1"></div>
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    ...
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Today Visited</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $visitor7->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch1" class="ht-50 tr-y-1"></div>
                            </div>
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    <i class="fa-duotone fa-list-ul tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Monthly Visited</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $visitor30->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch1" class="ht-50 tr-y-1"></div>
                            </div>
                       ...
                       <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-secondary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    <i class="fa-duotone fa-user tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Monthly User</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $user30->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch2" class="ht-50 tr-y-1"></div>
                            </div>
                       ...
                       <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    <i class="fa-duotone fa-cart-shopping tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Monthly Sale</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $cart30->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch3" class="ht-50 tr-y-1"></div>
                            </div>
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    <i class="fa-duotone fa-screen-users tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Monthly Classes</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $classes30->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch4" class="ht-50 tr-y-1"></div>
                            </div>
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    <i class="fa-duotone fa-book tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Monthly Course</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $course30->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch1" class="ht-50 tr-y-1"></div>
                            </div>
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    <i class="fa-duotone fa-list-ul tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Yearly Visited</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $visitor365->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch1" class="ht-50 tr-y-1"></div>
                            </div>
                       ...
                       <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-secondary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    <i class="fa-duotone fa-user tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Yearly User</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $user365->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch2" class="ht-50 tr-y-1"></div>
                            </div>
                       ...
                       <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    <i class="fa-duotone fa-cart-shopping tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Yearly Sale</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $cart365->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch3" class="ht-50 tr-y-1"></div>
                            </div>
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    <i class="fa-duotone fa-screen-users tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Yearly Classes</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $classes365->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch4" class="ht-50 tr-y-1"></div>
                            </div>
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    <i class="fa-duotone fa-book tx-60 lh-0 tx-white op-7"></i>
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Yearly Course</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $course365->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch1" class="ht-50 tr-y-1"></div>
                            </div>
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    ...
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Teacher</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $teacher365->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch1" class="ht-50 tr-y-1"></div>
                            </div>
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3">
                            <div class="bg-primary rounded overflow-hidden">
                                <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                                    ...
                                    <div class="mg-l-20">
                                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Student's</p>
                                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $student365->count() }}</p>
                                    </div>
                                </div>
                                <div id="ch1" class="ht-50 tr-y-1"></div>
                            </div>
                    ...
                    <div class="card shadow-base bd-0 overflow-hidden">
                        ...
                        <div class="bg-teal pd-x-25 pd-b-25 d-flex justify-content-between">
                            <div class="tx-center">
                                ...
                                <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase mg-b-0 tx-white-8">Total Space
                                </p>
                            </div>
                            <div class="tx-center">
                                <h3 class="tx-lato tx-white mg-b-5">234<span class="tx-light op-8 tx-20">gb</span></h3>
                                <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase mg-b-0 tx-white-8">Used Space
                                </p>
                            </div>
                            <div class="tx-center">
                                <h3 class="tx-lato tx-white mg-b-5">80<span class="tx-light op-8 tx-20">%</span></h3>
                                <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase mg-b-0 tx-white-8">Free Space
                                </p>
                            </div>
                        </div>
                    </div><!-- card -->
                                ...
                                <div class="carousel-item active">
                                    <div
                                        ...
                                        <div class="pd-x-30 pd-t-30 mg-b-auto">
                                            <p class="tx-info tx-uppercase tx-11 tx-semibold tx-mont mg-b-5">Product Item
                                                #1</p>
                                    ...
                                    <div class="bg-br-primary pd-30 ht-300 pos-relative d-flex align-items-center rounded">
                                        ...
                                        <div class="tx-white">
                                            ...
                                            <nav class="nav flex-row tx-13">
                                                <a href="" class="tx-white-8 hover-white pd-l-0 pd-r-5">12K+
                                                    Views</a>
