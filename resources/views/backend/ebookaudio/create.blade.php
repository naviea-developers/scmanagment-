    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('admin.ebookaudio.index')}}"> <i class="icon ion-reply text-22"></i> All Ebook Audio</a>
          </nav>
        </div><!-- br-pageheader -->

        <div class="br-pagebody">
          <div class="br-section-wrapper">
            <h6 class="br-section-label text-center mb-4"> Add New Ebook Audio</h6>
               {{-- validate start  --}}
               @if(count($errors) > 0)
            ...
            <div class="col-xl-12 mx-auto">
                <div class="form-layout form-layout-4 py-5">
                    ...
                    <form action="{{ route('admin.ebookaudio.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-sm-4">
                                <label class="form-control-label"><b>Image: </b><span class="tx-danger">*</span></label>
                                    <div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 150px;">
                                        ...
                                        <input type="file" name="image" accept="image/*" class="form-control upload-img" placeholder="Enter Activity Image" style="position: absolute;top: 0;opacity: 0;height: 100%;" required>
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-sm-4 mt-3">
                              ...
                              <div class="col-sm-6 mt-3">
                                <label class="form-control-label"><b>Related E-Audio:</b></label>
                                <div class="mg-t-10 mg-sm-t-0">
                                    <select class="form-control multipleSelect2Search custom-select" name="relatedebook_id[]" multiple>
                                      <option value="">select related e-audio</option>
