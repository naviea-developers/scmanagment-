...
<div class="br-section-wrapper data-create" style="display: none;">
    <h6 class="br-section-label text-center mb-4"> Add New E-book</h6>
    {{-- validate start  --}}
    ...
    <div class="col-xl-12 mx-auto">
        <div class="form-layout form-layout-4 py-5">
            ...
            <form id="data-form-create" action="{{ route('admin.ebook.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-sm-4 mt-3">
                        ...
                        <div class="mg-t-10 mg-sm-t-0">
                            <select style="width: 100%" class="form-control multipleSelect2Search custom-select" name="relatedebook_id[]" multiple>
