    ...
    <div class="container-lg position-relative text-white py-5">
        <div class="text-center pt-5 py-md-5">
            <div class="header-logo mb-5 pt-5">
                <img src="{{ $home_content->banner_image_show }}"
                    class="img-fluid" alt="">
            ...
            <h2 class="fw-medium h3 text-uppercase" style="color: var(--button2_text_color)">{!!  $home_content->banner_text  !!}</h2>
            ...
            <div class="col-lg-6 offset-lg-1">
                <div class="header-video banner_video">
                    <a class="popup-youtube position-relative"
                        ...
                        <img src="{{ $home_content->sub_banner_thumbnail_show }}"
                            class="img-fluid" alt="">
                                    ...
                                    <label
                                        ...
                                        <span class="align-items-center d-flex  rounded text-center">
                                            ...
                                            @if($course->discount > 0)
                                                ...
                                                @endif
                                            @else
                                            <span class="d-block fs-16 fw-bold me-2 text-success2">BDT {{ $course->fee }}</span>
                                            @endif
                                ...
                                <div class="d-flex justify-content-between align-items-stretch mt-2">
                                    ...
                                    <div class="flex-grow-1 me-2 w-sub">
                                        <a href="javascript:void(0);"
                                            ...
                                            <span class="text-center w-100 fw-bold fs-13 addcart" CarId="{{ $course->id }}" style="color: var(--button2_text_colo)">
                                                Add To Cart
                                            </span>
                                        </a>
...
<h3 class="fw-bold mb-5 text-center text-lg-start text-uppercase">{!! $home_content->learn_title !!}</h3>
{{-- <a href="allcourse/index.html"> --}}
    <img src="{{ $home_content->learn_image_show }}"
        class="img-fluid" alt="">
{{-- </a> --}}
</div>
<div class="col-lg-6">
        ...
        <li class="col-sm-6 col-md-6 col-lg-4 exclusive d-flex">
            <ul class="pricing-wrapper list-unstyled position-relative">
                ...
                <li data-type="monthly" class="is-visible d-flex flex-wrap h-100 align-content-between">
                    <header class="pricing-header text-center pt-5 pb-4 w-100">
                        {{-- <h2>Monthly Subscription Package</h2> --}}
                        <h2 style="color: var(--header_text_color)">{{ @$monthlyPackage->name }}</h2>
                            ...
                            <span class="currency fs-5 fw-bold mt-0" style="color: var(--header_text_color)">BDT</span>
                            <span
                                class="fw-bold value" style="color: var(--header_text_color)">{{ @$monthlyPackage->price }}</span>
                            <span
                                class="duration fw-bold text-lowercase" style="color: var(--header_text_color)">Month</span>
                        </div>
                        <!-- <p class="mb-0"></p> -->
                    </header>
                    <div class="pricing-body w-100">
                ...
                <li data-type="yearly" class="is-hidden d-flex flex-wrap h-100 align-content-between">
                    <h6 class=" p-2 position-absolute rounded-pill start-50 text-capitalize text-center translate-middle w-sub">
                        ...
                        <!-- <span>End Time <p id="example"></p></span> -->
                            ...
                            <span class="currency fs-5 fw-bold mt-0" style="color: var(--header_text_color)">BDT</span>
                            <span
                                class="fw-bold value" style="color: var(--header_text_color)">{{ @$yearlyPackage->discount }}</span>
                            <span
                                class="duration fw-bold text-lowercase text-white" style="color: var(--header_text_color)">YR</span>
                        </div>
                    ...
                    <footer class="pricing-footer w-100">
                        <a class="select d-inline-flex justify-content-center align-items-center" style="color: var(--header_color)"
                            href="{{ route('course.use.subscriptions',$yearlyPackage->id) }}">
                            <div class="btn-icon d-flex align-items-center justify-content-center me-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="15.793" height="15.793"
                                    viewBox="0 0 15.793 15.793">
                                    <path id="Path_357" data-name="Path 357"
