...
<main><!-- <input type="hidden" id="user_session" value=""> -->
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/img/fab.html">
    <!-- CSS here -->
    {{-- <link rel="stylesheet" href="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/css/bootstrap.min.css"> --}}
    {{-- <link rel="stylesheet" href="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/css/animate.min.css"> --}}
    <link rel="stylesheet" href="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/css/jquery.fancybox.min.css">
    <link rel="stylesheet" href="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/css/fontAwesome5Pro.css">
    <link rel="stylesheet" href="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/css/default.css">
    <link rel="stylesheet" href="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/css/style-latest.css">
    <link rel="stylesheet" href="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/css/responsive-latest.css">
                      ...
                      <div class="d-flex">
                         <div class="pr-10">
                            <a href="{{ $master_course->trailer_video_url }}" class="popup-youtube">
                               <img src="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/img/maestroclass/icon/trailer.svg" alt="">
                               <p>Trailer</p>
                            </a>
                         </div>
                         <div class="pl-10">
                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#shareModal">
                               <img src="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/img/maestroclass/icon/share.svg" alt="">
                               <p>Share</p>
                            </a>
                         </div>
                         <div class="pl-25">
                            <img src="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/img/maestroclass/icon/students.svg" alt="">
                            <p>43</p>
                         </div>
                      </div>
                   </div>
                         ...
                         <nav>
                            <div class="nav nav-tabs border-0" id="nav-tab" role="tablist">
                               <button class="nav-link active w-100" id="ct_trailer">
                                  <img src="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/img/maestroclass/icon/play.svg" alt=""> Trailer</button>
                                                       </div>
                         </nav>
                      </div>
                   </div>
                                     ...
                                     <h2 class="accordion-header">
                                        <button class="accordion-button d-flex gap-3 align-items-center" type="button"
                                           ...
                                           onclick="getVdo('{{ $k }}',
                                                          ...
                                                          'MLE05CVMKZ2800',
                                                          '{{ $lesson->name }}',
                                                          '{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/img/maestroclass/icon/playing.svg',
                                                          '{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/img/maestroclass/icon/play.svg');">
                                           <img src="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/img/maestroclass/icon/play.svg" 
