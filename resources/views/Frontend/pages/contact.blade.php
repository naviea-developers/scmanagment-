...
<div class="content_search" style="margin-top:70px">
    ...
    <link rel="stylesheet" href="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/css/intlTelInput.css">
    <style>
  .iti--allow-dropdown{
      width: 100%;
  }
...
<div class="bg-alice-blue py-3 py-lg-4">
    <div class="container-lg p-2 p-md-5">
                  ...
                  <div class="col-lg-6">
                      <div class="mapbox">
                          <!-- <div id="mapBox" class="" style="height: 450px" data-lat="23.751611" data-lon="90.370381"
                              ...
                              data-marker="https://lead.academy/{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/img/marker.png"
      ...
      <script src="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/js/intlTelInput.js"></script>
      <!--gmaps Js-->
      ...
      <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCCiXxFU3GJiFz35LlWrj_HgehXtHUmFPY"></script>
      <script src="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/js/gmaps.min.js"></script>
      <script  src="{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/js/utils.js"></script>
      <script>
  if ($("#mapBox").length) {
  ...
  var input = document.querySelector("#phoneNumber");
      var utilslink = '{{ asset('public/frontend') }}/application/modules/frontend/views/themes/default/assets/js/index.html';
