    ...
    <div class="container-lg">
        <div class="row mt-5">
            ...
            <h3 class="fw-bold mb-5 text-center text-lg-start text-uppercase" style="color:var(--text_color)">{!! $home_content->learn_title !!}</h3>
                <img src="{{ $home_content->learn_image_show }}" style="height: 375px; width:540px;"class="img-fluid" alt="">
            </div>
            <div class="col-lg-6">
            <div class="row g-3">
                <!-- d-flex -->
            ...
            <div class="collaborate2-carousel owl-carousel text-center">
                @foreach ($clients as $client)
                    <div class="brand_item">
                        <a href="{{ $client->link }}"target="_blank" ><img src="{{ $client->image_show }}" alt=""></a>
                    </div>
                @endforeach
            </div>
        </div>
