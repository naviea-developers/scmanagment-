<div id="payment">
    ...
    <form action="{{ url('application/submit/'.$application->id) }}" method="post">
        @csrf
    <!--single form panel-->
    <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
        ...
        <div class="has-fee">
            ...
            <div class="PriceToPay" style="text-align: justify;">
                <div class="d-flex">
                    <p class="service_type">Total Fee</p>:  <span class="fee mr-1" style="font-size: 1em;font-weight: bold;">{{ format_price($application->application_fee) }}</span>
                    <p class="app-already-paid ml-2 d-none text-success"> ✔️ Paid</p>

                </div>
            </div>
            <div class="service-notes">
                <input @if ($application->payment_method == 'bkash') checked @endif type="radio" id="option1" name="payment_method" value="bkash">
                <label for="option1">Pay With Bkash</label><br>
                <input @if ($application->payment_method == 'cush') checked @endif type="radio" id="option2" name="payment_method" value="cush">
                <label for="option2">Cush</label><br>
            </div>
        ...
        <div class="no-fee d-none">
            <div class="PriceToPay" style="text-align: justify;">
                <div class="d-flex">
                    <p class="service_type"> Application Fee</p>:  <span class="fee mr-1" style="font-size: 1em;font-weight: bold;">{{ format_price($application->application_fee) }}</span> 
                </div>
            </div>
        ...
        <div class="multisteps-form__content">
            ...
            <div class="d-flex align-items-baseline terms-conditions mt-2">
                <input type="checkbox" name="confirm-terms" id="confirm-terms" class="mr-2" onchange="activatePayment(this)">
                <label for="confirm-terms">I confirm I have read the <a href="#" data-toggle="modal" data-target="#refund_policy" style="color:#d71f27">refund policy</a> and <a href="#" data-toggle="modal" data-target="#service_terms" style="color:#d71f27">service terms</a>, and <a href="#" data-toggle="modal" data-target="#terms_conditions" style="color:#d71f27">terms and conditions</a> and agree to it.</label>
            </div>
                    ...
                    <ul>
                        <li class="payment-option">
                            ...
                            <h2 class="d-flex">Credit or Debit Card
                                <div class="payLogo">
                                    <img src="https://d2xtzyi0kjzog2.cloudfront.net/static/assets/img/credit-cards/card-logo-visa.e6f1a872f973.svg">
                                    <img src="https://d2xtzyi0kjzog2.cloudfront.net/static/assets/img/credit-cards/card-logo-mastercard.e46010096770.svg">
                                    <img class="onlyOnDesktop" src="https://d2xtzyi0kjzog2.cloudfront.net/static/assets/img/credit-cards/card-logo-amex.1f9002692bff.svg">
                                    <img class="onlyOnDesktop" src="https://d2xtzyi0kjzog2.cloudfront.net/static/assets/img/credit-cards/Maestro_logo.324dcd1ab138.svg">
                                    <img src="https://d2xtzyi0kjzog2.cloudfront.net/static/assets/img/credit-cards/UnionPay_logo.9b59a572fd63.svg">
                                </div>
                            </h2>
                                ...
                                <div class="">
                                    ...
                                    <div class="" style="margin-bottom: 30px; text-align: center;">
                                        <div class="PriceToPay">
                                            $<span class="fee">{{ format_price($application->application_fee) }}</span>
                                        </div>
                                        <div id="stripe-submit" class="button red">
                                            Pay Now</div>
                                        <img src="https://d2xtzyi0kjzog2.cloudfront.net/static/assets/img/poweredByStripe.d86d23018a86.png" style="width: 100px;">
                                    </div>
                                </div>
                        ...
                        <li class="payment-option">
                            ...
                            <h2 class="d-flex">Wechat Pay
                                <img class="payLogo" src="https://d2xtzyi0kjzog2.cloudfront.net/static/assets/img/Wechat-Pay.99580c6de287.png">
                            </h2>
                            <div class="open">
                                <p>To pay by Wechat please scan the QR code
                                    ...
                                    <div class="" style="margin-bottom: 30px; text-align: center;">
                                        <img class="dis" width="300px" src="/static/assets/img/wechat-qrcode.png"><div class="PriceToPay">
                        ...
                        <li class="payment-option" id="paypal_accordion">
                            <input type="checkbox" checked="" disabled="">
                            <i></i>
                            <h2 class="d-flex pb-3">Paypal <img class="payLogo" src="https://d2xtzyi0kjzog2.cloudfront.net/static/assets/img/PayPal_Logo.fa90774cf997.svg">
                            </h2>
                            <div class="open">
                                <div class="">
                                    <h3>Instructions</h3>
                                ...
                                <div class="">
                                    <div class="PriceToPay">
                                        <span class="fee mr-1">{{ format_price($application->application_fee) }}</span>
                                    </div>
                        ...
                        <li class="payment-option">
                            ...
                            <h2 class="d-flex">Bank Transfer
                                <img class="payLogo" src="https://d2xtzyi0kjzog2.cloudfront.net/static/assets/img/bankTransfer.a88bb0110744.png">
                            </h2>
                            <div class="open">
                                <p>
                                    For bank transfer: <br>
                                    Please make sure to cover any bank fees. We suggest you use <a href="http:// wise.com" target="_blank"> wise.com</a> to transfer the payment for faster transactions and lower fees.
                                </p>
                                    ...
                                    and Thai Baht (THB)</p>
                                        ...
                                        <div class="list-group-item d-flex justify-content-between receipt-attachment">
                                            ...
                                            <form class="upload-receipt" action="" method="post">
                                                ...
                                                <input hidden="" type="text" name="title" value="Payment Receipt">
            ...
            <div class="button-row d-flex mt-4">
                <button class="btn btn-secondary js-btn-prev" type="button" title="Prev">
                    ...
                    {{-- @if ($application->status == 0) --}}
                        <button class="btn btn-danger   ml-auto submit-payment" id="submit-payment" type="submit" title="Next">
