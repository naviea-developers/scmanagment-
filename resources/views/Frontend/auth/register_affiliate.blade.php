            ...
            <div class="col-xl-9">
                <div class="border-md mx-0 rounded-3 row">
                    ...
                    <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                        ...
                        <input type="hidden" name="type" id="user_type" value="6">
                      ...
                      <div class="mt-sm-4 text-center"> Already have an account?<strong>
                                <a href="{{ route('frontend.affiliate_signin') }}"class="text-decoration-underline">Sign in</a>                            </strong>
                        </div>
                    </div>
                </div>
            </div>
