                ...
                <div class="border-md mx-0 rounded-3 row">
                    <div class="border-end-md col-md-6 p-sm-5 px-5">
                     ...
                     @endphp
                        ...
                        <center class="text-center">
                            <a href="{{ route('frontend.register') }}"><strong> Become a Student</strong></a>                        </center>
                        ...
                        <img class="d-block img-fluid mx-auto" style="margin-top:50px; height:380px; width:330px;" src="{{  $home_content->register_image_show }}"
                            width="344" alt="image">
                    </div>
                    <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                      ...
                      <div class="mt-sm-4 text-center"> Already have an account?<strong>
                                <a href="{{ route('frontend.consultant_signin') }}"class="text-decoration-underline">Sign in</a>                            </strong>
                        </div>
                    </div>
                </div>
            </div>
