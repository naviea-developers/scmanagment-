            ...
            <div class="col-xl-9">
                <div class="border-md mx-0 rounded-3 row">
                    <div class="border-end-md col-md-6 p-sm-5 px-5">
                     ...
                     @endphp
                        ...
                        <center class="text-center">
                            <a href="{{ route('frontend.register') }}"><strong> Become an Student</strong></a>                        
                        </center>
                        {{-- <center class="text-center">
                              <a href="{{ route('frontend.seller_register') }}"><strong> Become an Seller</strong></a>                        
                        </center>
                        <center class="text-center">
                    ...
                    <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                        ...
                        <input type="hidden" name="type" id="user_type" value="2">
                      ...
                      <div class="mt-sm-4 text-center"> Already have an account?<strong>
                                <a href="{{ route('frontend.teacher_signin') }}"class="text-decoration-underline">Sign in</a>                            </strong>
                        </div>
                    </div>
                </div>
            </div>
