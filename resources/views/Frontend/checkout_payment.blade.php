                    ...
                    <div class="card-body p-4 p-xl-5">
                        ...
                        <ul class="list-group mb-3" style="list-style: none;" id="chkout">
                           ...
                           <li class="border-bottom d-flex justify-content-between lh-sm mb-2 pb-2 coupon-areashow"
                                id="couponAmountRow" @if(!session()->has("add_coupon_code")) style="display:none!imporant;" @endif>
                                <div>
                      ...
                      @if ($payment_gateway->stripe_status=='1')
                         <div class="payment-block" id="stipe_payment">
                            <div class="payment-item mb-3">
                                ...
                                <img src="{{ asset('public/upload/paymentgateway/'.$payment_gateway->stripe_icon) }}" alt="stripe_logo" width="80px" height="95px" class="img-fluid mb-2 p-2"/>
                             </div>
                      ...
                      @if ($payment_gateway->paypal_status=='1')
                         <div class="payment-block" id="paypal_payment">
                            <div class="payment-item mb-3">
                                ...
                                <img src="{{ asset('public/upload/paymentgateway/'.$payment_gateway->paypal_icon) }}" alt="paypal_logo" width="90px" height="70px" class="img-fluid mb-2 p-2"/>
                            </div>
                        </div>
                      @endif
...
<script src="{{asset('public/frontend/payment_method.js')}}"></script>
@endif
@endsection
