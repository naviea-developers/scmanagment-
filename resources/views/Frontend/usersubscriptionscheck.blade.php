...
@section('title','- User Subscription Check')
@section('head')
...
<form action="{{route('package.subscription.order')}}"  enctype="multipart/form-data" method="post">
@csrf
    ...
    <div class="container-lg p-0">
        <div class="row g-1">
                ...
                <div class="card border-0 rounded-0 shadow-sm mb-3 page-section">
                    <div class="card-body p-4 p-xl-5">
                        ...
                        <h5 class="d-flex justify-content-between align-items-center mb-3">
                            <span class="text-dark-cerulean">Your Course Subscriptions Amount</span>
                            <!-- <span class="badge bg-dark-cerulean rounded-circle">3</span> -->
                        </h5>
                        @if(session('subscriptionscart'))
                                @php
                                    $total=0;
                                @endphp
                                @foreach(session('subscriptionscart') as $id => $details)
                                @php
                                   $total =$total+ $details['packageprice']
                                @endphp
                                @endforeach
                        @endif
                        <ul class="list-group mb-3" style="list-style: none;" id="chkout">
                            <li class="border-bottom d-flex justify-content-between lh-sm mb-2 pb-2">
                                <div>
                                    <h6 class="my-0">Course Subscriptions</h6>
            ...
            <div class="col-md-7 col-lg-8 sticky-content">
                <div class="card border-0 rounded-0 shadow-sm mb-3 page-section">
                    <div class="card-body p-4 p-xl-5">
                        <h5 class="mb-3 text-dark-cerulean">Course Subscript From</h5>
                        <!-- <form class="needs-validation" novalidate> -->
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        {{-- <th>Image</th> --}}
                                        <th class="min_width_340p">Package Name</th>
                                        <th>Price</th>
...
$(document).ready(function() {
    $(".delete-button").click(function() {
        $("#delete-modal").show();
        $("#subscriptionscartId").val($(this).attr('subscriptionscartId'))
...
$('.subscriptionscartremove').on('click',function(){
    var id=$(this).attr('subscriptionscartId');
    Swal.fire({
    ...
    if (result.isConfirmed) {
        window.location ="{{ url('/remove-from-cart-subscriptions') }}/"+id
    }
    });
});
