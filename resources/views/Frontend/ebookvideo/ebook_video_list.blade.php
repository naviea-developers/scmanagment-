        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="row blog_search mb-4 g-3">
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="bg-white border d-block p-3">
                            <select id="event_category" class="form-select rounded-0 box on_click_ebook_audio_category" aria-label="Default select example">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                        ...
                        <div class="course-card rounded-3 bg-white position-relative overflow-hidden">
                            <div class="position-relative">
                                <!--Start Course Image-->
                                <a href="{{ route('frontend.ebook_video_details',$event->id) }}"
                                    class="">
                                ...
                                <div
                                    ...
                                    <h3 class="course-card__course--title text-uppercase fs-6 mb-1">
                                        <a href="{{ route('frontend.ebook_video_details',$event->id) }}" class="text-decoration-none" style="color: var(--product_text_color)">{{ $event->title}}</a>
                                    </h3>
                                    <p class=" text-uppercase fs-6 ebook-title2">
                                        <a href="{{ route('frontend.ebook_video_details',$event->id) }}" class="text-decoration-none" style="color: var(--product_text_color)">{{ $event->headline}}</a>
                                    </p>
