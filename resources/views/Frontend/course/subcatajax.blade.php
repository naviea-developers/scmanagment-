         ...
         {{-- <div class="category-banner text-white p-4 p-sm-5 mb-4 position-relative overflow-hidden">
            ...
            <div class="position-relative">
                ...
                <p class="mb-0 cat_shot_txt"> Find what fascinates you as you explore these courses.</p>
            </div>
        </div> --}}
        <!--End Category Banner-->
        <!--Start Course Search-->
                            ...
                            <div class="course-card__hover--content">
                                ...
                                <h3 class="bottom-0 course-card__hover--content___text d-block fs-15 mb-0 position-absolute text-decoration-none text-white">
                                    <!-- <a href=""
                                        ...
                                        <a href=course-details/CO13RT58I93.html class="text-decoration-none" style="color: var(--product_text_color)">{{ @$course->name }}</a>
                                </h3>
                            </div>
                        </div>
