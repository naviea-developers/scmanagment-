<div class="header">
    <div class="container-fluid">
        <div class="searchbox">
            <div class="row">
                <div class="col-md-4">
                    <a href="/"><img src="<?php echo e(asset('frontend/img/footer_logo.png')); ?>" alt=""></a>
                </div>
                <div class="col-md-4">
                    <ul>
                        <li>
                ...
                <div class="col-md-4">
                    <ul>
                        ...
                        <li>
                            <a href="/userProfile" class="btn" style="background:none; border:none; outline:none;"><i class=" fas fa-user"></i></a>
                        </li>
                        <?php else: ?>
                        <li>
...
<?php /**PATH D:\desktop\MTH\NewAdminTamplate\resources\views/frontend/inc/header.blade.php ENDPATH**/ ?>